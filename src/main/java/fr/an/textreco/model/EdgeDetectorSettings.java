...
public class EdgeDetectorSettings implements ViewModel {
    ...
    public DoubleProperty cannyThreshold1Property() {
        return cannyThreshold1;
    }

    public double getCannyThreshold1() {
        return cannyThreshold1.get();
    }

    public void setCannyThreshold1(double v) {
        cannyThreshold1.set(v);
    }

    public DoubleProperty cannyThreshold2Property() {
        return cannyThreshold2;
    }

    public double getCannyThreshold2() {
        return cannyThreshold2.get();
    }

    public void setCannyThreshold2(double v) {
        cannyThreshold2.set(v);
    }
}
