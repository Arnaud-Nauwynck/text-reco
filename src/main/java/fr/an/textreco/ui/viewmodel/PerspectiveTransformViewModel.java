...
public class PerspectiveTransformViewModel implements ViewModel {
    ...
    public ObjectProperty<WritableImage> perspectiveImageProperty() { return context.perspectiveImageProperty; }

    public PerspectiveTransformProcessor getProcessor() { return processor; }
}
