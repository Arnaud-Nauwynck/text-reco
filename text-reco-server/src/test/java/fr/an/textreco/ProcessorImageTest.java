...
class ProcessorImageTest {
    ...
    private static final String IMAGE_PATH = "src/test/term36-consolas-base64-bis.png";
    ...
    void valleyDetector_lineHeight_isInExpectedRange() {
        ...
        settings.setMinLineH(30);
        settings.setMaxLineH(70);
        settings.setMinCharW(12);
        settings.setMaxCharW(40);
    ...
    void correlationDetector_lineHeight_isInExpectedRange() {
        ...
        settings.setMinLineHeight(30);
        settings.setMaxLineHeight(70);
        settings.setSmoothingAlpha(1.0);
